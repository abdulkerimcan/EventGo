...
public class ConcertsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.fragment_concerts, container, false);
        mAuth = FirebaseAuth.getInstance();
        mUser = mAuth.getCurrentUser();
        categoryList = new ArrayList<>();
        mFirestore = FirebaseFirestore.getInstance();

        mRecycler = v.findViewById(R.id.recyclerviewConcert);
                ...
                if (error !=null) {
                    ...
                    for (DocumentSnapshot snapshot : value.getDocuments()) {
                        ...
                        if (category.matches("Concerts")) {
                            ...
                            categoryItem = new CategoryItem(eventname, location, date, downloadURL, info, hour,uuid,latitude,longitude,price,count,organizerID,starCount);
